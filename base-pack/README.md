# VSCode Base Development Tools Pack

![Banner](assets/banner.jpeg)

This extension pack adds more features to VS Code! These are the basic extensions to make editing easier and fun in VSC.

The best Development Tools extensions for Visual Studio Code are now available as a single package, so you don't have to manually install them one by one.
